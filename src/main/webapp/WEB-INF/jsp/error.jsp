...
<head>
 ...
 <title>Product List - Error</title>
...
<body>
 <div class="container">
  <h1 style="border-bottom: solid #EAEDED;">Products - Error</h1>
  <p>
  Looks like there was an error. <p> Please try your search again with at least one field populated. </p>
  <table class="table">
  	<tr>
